...
const Login = () => {
  ...
  const onLoginWithGoogle = async (credential: string) => {
  ...
  return (
    <Container maxWidth='xs'>
      ...
      >
        ...
        <Box component='form' onSubmit={onFormSubmit} sx={{ mt: 3, mb: 1 }}>
          ...
          <GoogleLogin
            onSuccess={(credentialResponse) => {
              if (credentialResponse.credential) {
                void onLoginWithGoogle(credentialResponse.credential);
              }
            }}
            onError={() => {
